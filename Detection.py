    ...
    def __init__(self, top=None):
        ...
        def sendChalan(event):
            ...
            try:
                ...
                self.yag.send(to='yuvrajsurshetwar@gmail.com', subject="Traffic Rule Challan", contents=message, attachments=data[0])
                self.yag.close()
        ...
        self.Label1.configure(text='''Helmet Detected Interface''')
